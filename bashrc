...
[ -f "$df/git-completion.bash" ]   && source "$df/git-completion.bash"
...
alias Gl='git pull'
alias GL='git log'
alias Gld='cd $df; git pull; sleep 3; builtin cd -; sb'
alias Gc='git commit'
...
alias r='ls -trl --color=always | less'
alias ra='ls -tral --color=always | less'
alias r1='ls -1tr  --color=always | less'
alias sb='echo source $df/bashrc; source $df/bashrc'
alias S='sudo'
alias SD='sudo $(fc -ln -1)'
alias tc='tmux choose-buffer'
alias t0='tmux set -g status off'
alias t1='tmux set -g status on'
alias tn='tmux rename-window'
alias tse='tmux showenv'
